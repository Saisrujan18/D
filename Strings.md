...
- [x] [Balanced Parenthesis problem ](https://practice.geeksforgeeks.org/problems/parenthesis-checker/0)
...
- [x] [Number of flips to make binary string alternate](https://practice.geeksforgeeks.org/problems/min-number-of-flips/0)
- [x] [Find the first repeated word in string.](https://practice.geeksforgeeks.org/problems/second-most-repeated-string-in-a-sequence/0)
